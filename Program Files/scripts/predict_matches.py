from distance_classifier import distance_classifier, name_distance
import npi_grants_combine

#Loading reusable classifier 
model = distance_classifier.DistanceClassifier('trained_model', 'xgb')
...
test_data = npi_grants_combine.read(r"data\npidata_pfile_20240205-20240211.csv")
